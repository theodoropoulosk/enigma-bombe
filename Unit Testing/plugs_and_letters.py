...
def enter_settings(numcon):
    ...
    for j in range(start, (start+numcon)):
        ...
        while ok == 0:
            time.sleep(1)
            keyboard.write(testcase[2 + adder])
...
## ---------------- UNIT TEST HERE  ----------------------
with open("three_test4.txt","r") as f:#change the name of text file to change test case
...
time.sleep(1)
keyboard.write(testcase[2 + int(adder)])
keyboard.press('enter')
time.sleep(1)
keyboard.write(testcase[3 + int(adder)])
keyboard.press('enter')
time.sleep(1)
keyboard.write(testcase[4 + int(adder)])
keyboard.press('enter')
...
time.sleep(1)
keyboard.write(testcase[6 + int(adder)])
keyboard.press('enter')
...
i = 0
y = 7 + int(adder)
for x in range(int(testcase[5 + int(adder)])):
