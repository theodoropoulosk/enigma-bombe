...
def asign_starts(rotor1, rotor2, rotor3):
	...
	while int(setting1) < 0 or int(setting1) > 25:
		setting1 = input("Input out of range for rotor 1. Try again: ")
		
	setting2 = input("Enter the starting configuration of rotor 2 (number 0-25) ")
	while int(setting2) < 0 or int(setting2) > 25:
		setting2 = input("Input out of range for rotor 2. Try again: ")
			
	setting3 = input("Enter the starting configuration of rotor 3 (number 0-25) ")
	while int(setting3) < 0 or int(setting3) > 25:
		setting3 = input("Input out of range for rotor 3. Try again: ")
...
while (selection1 == selection2) or (selection2 == selection3) or (selection1 == selection3):
	selection1= input("Please enter your selection for rotor 1 (1-5): ")
	while int(selection1) < 1 or int(selection1) > 5:
		selection1= input("Input out of range for rotor 1. Try again: ")

	selection2= input("Please enter your selection for rotor 2 (1-5): ")
	while int(selection2) < 1 or int(selection2) > 5:
		selection2= input("Input out of range for rotor 2. Try again: ")
	
	selection3= input("Please enter your selection for rotor 3 (1-5): ")
	while int(selection3) < 1 or int(selection3) > 5:
		selection3= input("Input out of range for rotor 3. Try again: ")
		
	if (selection1 == selection2) or (selection2 == selection3) or (selection1 == selection3):
		print("The same rotor can not be selected more than once. Try again")

refselection= input("please enter your selection for the reflector (1-3): ")	
while int(refselection) < 1 or int(refselection) > 3:
	refselection= input("Input out of range for reflector. Try again: ")
...
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx KEYBOARD xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
	...
	plugCL = Button(gui, image = plugCL_image, command=lambda: update_connection_list('c'), height=50, width=53)
