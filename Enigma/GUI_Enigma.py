...
def asign_starts(rotor1, rotor2, rotor3):
	...
	setting2 = 0
	setting3 = 0
	while int(setting1) >= 0 and int(setting1) < 26:
		setting1 = input("Enter the starting configuration of rotor 1 (number 0-25) ")
		if int(setting1) < 0 or int(setting1) >= 26:
			print("Invalid input. Try again.")
		
	while int(setting2) >= 0 and int(setting2) < 26:
		setting2 = input("Enter the starting configuration of rotor 2 (number 0-25) ")
		if int(setting2) < 0 or int(setting2) >= 26:
			print("Invalid input. Try again.")
			
	while int(setting3) >= 0 and int(setting3) < 26:
		setting3 = input("Enter the starting configuration of rotor 3 (number 0-25) ")
		if int(setting3) < 0 or int(setting3) >= 26:
			print("Invalid input. Try again.")
...
while(set==0):
	...
	while int(refselection) < 1 and int(refselection) >= 4:
		refselection= input("please enter your selection for the reflecor (1-3): ")
		if int(refselection) >= 1 or int(refselection) < 4:
			break
		else:
			print("Invalid input. Try again.")
